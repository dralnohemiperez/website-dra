      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold text-gray-800">Dra. Luisa N. Pérez</span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2 text-gray-600 text-sm">
                ...
                <span>+502 3001-5348</span>
              </li>
              <li className="flex items-center space-x-2 text-gray-600 text-sm">
                <div className="bg-pink-50 p-2 rounded-lg">
                  <Mail className="h-4 w-4 text-pink-500" />
                </div>
                <span>nohemiiperezz@gmail.com</span>
              </li>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              © {new Date().getFullYear()} Dra. Luisa N. Pérez. Todos los derechos reservados.
            </p>
            <Link
              href="/login"
